...
var _jsStringify = require('js-stringify');

var _jsStringify2 = _interopRequireDefault(_jsStringify);
    ...
    value: function snap() {
      ...
      return (0, _snapshot2.default)(this.protocol, this.host, urlPath, this.snapshotDelay).then(function (window) {
        if (window.snapshotState != null) {
          var stateString = (0, _jsStringify2.default)(window.snapshotState);
